...
@RunWith(Suite.class)
@SuiteClasses({ Prerequisite.class, ObjectGraph1.class, ObjectGraph1a.class, ObjectGraph2.class, ObjectGraph3.class, ObjectGraph3b.class,
        ObjectGraph3c.class, ObjectGraph4.class, ObjectGraph5.class })
